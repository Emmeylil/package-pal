          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-muted-foreground">Approx 60x40x20 cm. Phones, shirts, books.</p>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-muted-foreground">Approx 80x60x40 cm. Blenders, shoes, laptops.</p>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="font-bold text-foreground">Large Package (15-35kg)</p>
                    <p className="text-sm text-muted-foreground">Approx 140x80x60 cm. Microwaves, bulk items.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="p-8">
              ...
              <div className="mt-4 pt-4 border-t border-border text-center">
                <a href="#" className="text-primary font-bold text-sm hover:underline">View Full Rate Card →</a>
              </div>
            </div>
          </div>
        </div>
